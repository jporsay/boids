        ...
        \subsection{Sin boids especiales}
            ...
            \subsection{Con boids especiales}
                ...
                \begin{figure}[H]
                    ...
                    \caption{Polarización variando Tendencia especial a boid}
                    \label{fig:polarization_s}
                \end{figure}

                Dependiendo del factor de la regla, los boids se verán atraídos ($t > 0$) o repelidos ($t < 0$) de cada una de las entidades especiales.

                Se puede observar que incorporar éstas entidades especiales dentro del universo no permite que se pueda llegar a una polarización cercana a $1$, manteniéndose cerca de $0.9$.
