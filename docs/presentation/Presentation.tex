\documentclass{beamer}
    ...
    \section{Implementación}
        ...
        \begin{frame}
            ...
            \begin{columns}
                ...
                \begin{itemize}
                    \item $\mathbf{R} = 0.2 + (position.\mathbf{x} / width) * 0.8$
                    \item $\mathbf{G} = 0.2 + (position.\mathbf{y} / height) * 0.8$
                    \item $\mathbf{B} = 0.2 + (position.\mathbf{z} / depth) * 0.8$
                \end{itemize}
                \column{0.6\textwidth}
                \includegraphics[width=0.6\paperwidth,height=0.45\paperwidth,keepaspectratio]{{../imgs/universe__id_0772.frame0}.png}
            \end{columns}
        \end{frame}
    ...
    \section{Resultados}
        ...
        \begin{frame}[standout]
            \frametitle{Alineamiento: a = 0.0}
            \begin{tikzpicture}[remember picture,overlay]
                \node[anchor=south] at (current page.south) {
                    \movie[width=0.84\paperwidth,height=0.63\paperwidth,showcontrols,autostart]
                    {\includegraphics[width=0.84\paperwidth,height=0.63\paperwidth]
                        {{../anims/universe__id_0772.a_0.0.sim}.png}
                    }
                    {../anims/universe__id_0772.a_0.0.sim.mov}
                };
            \end{tikzpicture}
        \end{frame}

        \begin{frame}[standout]
            \frametitle{Alineamiento: a = 0.5}
            \begin{tikzpicture}[remember picture,overlay]
                \node[anchor=south] at (current page.south) {
                    \movie[width=0.84\paperwidth,height=0.63\paperwidth,showcontrols,autostart]
                    {\includegraphics[width=0.84\paperwidth,height=0.63\paperwidth]
                        {{../anims/universe__id_0772.a_0.5.sim}.png}
                    }
                    {../anims/universe__id_0772.a_0.5.sim.mov}
                };
            \end{tikzpicture}
        \end{frame}
        ...
        \begin{frame}[standout]
            \frametitle{Cohesión: c = 0.0}
            \begin{tikzpicture}[remember picture,overlay]
                \node[anchor=south] at (current page.south) {
                    \movie[width=0.84\paperwidth,height=0.63\paperwidth,showcontrols,autostart]
                    {\includegraphics[width=0.84\paperwidth,height=0.63\paperwidth]
                        {{../anims/universe__id_0772.c_0.0.sim}.png}
                    }
                    {../anims/universe__id_0772.c_0.0.sim.mov}
                };
            \end{tikzpicture}
        \end{frame}

        \begin{frame}[standout]
            \frametitle{Cohesión: c = 0.5}
            \begin{tikzpicture}[remember picture,overlay]
                \node[anchor=south] at (current page.south) {
                    \movie[width=0.84\paperwidth,height=0.63\paperwidth,showcontrols,autostart]
                    {\includegraphics[width=0.84\paperwidth,height=0.63\paperwidth]
                        {{../anims/universe__id_0772.c_0.5.sim}.png}
                    }
                    {../anims/universe__id_0772.c_0.5.sim.mov}
                };
            \end{tikzpicture}
        \end{frame}
        ...
        \begin{frame}[standout]
            \frametitle{Separación: s = 0.0}
            \begin{tikzpicture}[remember picture,overlay]
                \node[anchor=south] at (current page.south) {
                    \movie[width=0.84\paperwidth,height=0.63\paperwidth,showcontrols,autostart]
                    {\includegraphics[width=0.84\paperwidth,height=0.63\paperwidth]
                        {{../anims/universe__id_0772.s_0.0.sim}.png}
                    }
                    {../anims/universe__id_0772.s_0.0.sim.mov}
                };
            \end{tikzpicture}
        \end{frame}

        \begin{frame}[standout]
            \frametitle{Separación: s = 0.5}
            \begin{tikzpicture}[remember picture,overlay]
                \node[anchor=south] at (current page.south) {
                    \movie[width=0.84\paperwidth,height=0.63\paperwidth,showcontrols,autostart]
                    {\includegraphics[width=0.84\paperwidth,height=0.63\paperwidth]
                        {{../anims/universe__id_0772.s_0.5.sim}.png}
                    }
                    {../anims/universe__id_0772.s_0.5.sim.mov}
                };
            \end{tikzpicture}
        \end{frame}
